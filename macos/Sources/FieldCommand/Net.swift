...
/// mirrors snapshots.
enum NetProtocol {
    static let version = 10     // … 8 Armory; 9 Medics; 10 Artillery, Shield Generator, building shield on the wire
    ...
    static let buildingKinds: [BuildingKind] = [.hq, .depot, .barracks, .factory, .turret, .radar, .artillery, .shield]
