...
/// mirrors snapshots.
enum NetProtocol {
    static let version = 21     // … 19 tech (entrenchment, stabilisers); 20 alloy; 21 land mines
    ...
    static let buildingKinds: [BuildingKind] = [.hq, .depot, .barracks, .factory, .turret, .radar, .artillery, .shield, .wall, .mine]
