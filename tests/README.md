...
| macOS `FC_*TEST` hooks | The Swift simulation and client, headless: `FC_WORLDTEST`, `FC_REPAIRTEST`, `FC_TEAMSTEST`, `FC_SAVETEST`, `FC_MEDICTEST`, `FC_PINGTEST`, `FC_ARTYTEST`, `FC_CRATETEST`, `FC_CAMPAIGNTEST`, `FC_REPLAYTEST`, `FC_HIGHTEST`, `FC_POLISHTEST`, `FC_BRIDGETEST=map` | a macOS build |
