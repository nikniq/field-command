...
from .defs import DEFAULT_WORLD
...
# Each map's world size. The mega maps are half again as wide and tall to hold twelve bases.
MEGA_WORLD = (6000.0, 4200.0)
SIZES = {m["id"]: (MEGA_WORLD if m["players"] > 4 else DEFAULT_WORLD) for m in CATALOG}
...
def _finish(map_id, starts, expansions, roads, seed, walls=(), bridges=()):
    ...
    for (x, y, n, amount) in expansions:
        ...
        for i in range(n):
            a = i / n * 2 * math.pi + 0.3
            crystals.append([round(x + math.cos(a) * 70, 1), round(y + math.sin(a) * 70, 1), amount, variant % 3])
            variant += 1
...
def twin_ridges():
    ...
    expansions = [(2000, 480, 6, 1000), (2000, 2320, 6, 1000), (520, 2280, 6, 1000), (3480, 520, 6, 1000), (2000, 1400, 4, 2000)]
    roads = [
...
def highland_pass():
    ...
    expansions = [(420, 1400, 6, 1000), (3580, 1400, 6, 1000), (2000, 1400, 4, 2000), (2000, 480, 6, 1000), (2000, 2320, 6, 1000)]
...
def four_corners():
    ...
    c = (_W / 2, _H / 2)
    expansions = [(2000, 430, 6, 1000), (2000, 2370, 6, 1000), (430, 1400, 6, 1000), (3570, 1400, 6, 1000), (c[0], c[1], 4, 2000)]
    roads = [
...
def crossroads():
    ...
    c = (_W / 2, _H / 2)
    expansions = [(380, 380, 6, 1000), (3620, 380, 6, 1000), (380, 2420, 6, 1000), (3620, 2420, 6, 1000), (c[0], c[1], 4, 2000)]
